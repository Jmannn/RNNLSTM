...
iam """
    ...
    for i in range(0, outputSize):
        ...
        print(i)
        print()
        #print("returnData[0:-1,index[0]]")
        #print(returnData[0:-1,index[0]])
        #print(returnData[0:-1,index[0]].astype(float).ravel())
    #print(output)
    #print(np.zeros(output.shape[0]))
    print("---------")
    print(np.vstack((np.zeros(output.shape[0]), output.T)))
